...
static const AVOption vvflip_options[] = {
    { NULL }
};

AVFILTER_DEFINE_CLASS(vvflip);
...
static const AVFilterPad avfilter_vf_vvflip_inputs[] = {
    {
        .name             = "default",
...
static const AVFilterPad avfilter_vf_vvflip_outputs[] = {
    {
        .name = "default",
        .type = AVMEDIA_TYPE_VIDEO,
    },
...
const AVFilter ff_vf_vvflip = {
    .name        = "vvflip",
    .description = NULL_IF_CONFIG_SMALL("Flip the input video vertically."),
    .priv_size   = sizeof(FlipContext),
    .priv_class  = &vvflip_class,
    FILTER_INPUTS(avfilter_vf_vvflip_inputs),
    FILTER_OUTPUTS(avfilter_vf_vvflip_outputs),
